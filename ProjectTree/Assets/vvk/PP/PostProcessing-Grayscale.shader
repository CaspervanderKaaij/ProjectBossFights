	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float3 desaturateInitialColor20 = tex2DNode13.rgb;
				float desaturateDot20 = dot( desaturateInitialColor20, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar20 = lerp( desaturateInitialColor20, desaturateDot20.xxx, _InvertStrength );
				float4 lerpResult18 = lerp( tex2DNode13 , float4( desaturateVar20 , 0.0 ) , _InvertAlpha);
...
/*ASEBEGIN
Version=17400
0;73.6;1540;712;821.709;-121.3413;1.3;True;False
...
Node;AmplifyShaderEditor.DesaturateOpNode;20;53.72404,556.2311;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=72DF2113E2F2118FF356914FBC5D158F5372AF16