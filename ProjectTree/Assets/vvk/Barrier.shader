...
Shader "Remasu/Barrier"
{
	Properties
	{
		...
		_CrackAngle("CrackAngle", Float) = 0
		_CrackScale("CrackScale", Float) = 0
		_CrackProgress("CrackProgress", Range( 0 , 0.005)) = 0
		[HDR]_CrackColor("CrackColor", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		uniform float _CrackAngle;
		uniform float _CrackProgress;
		...
		float voronoi34( float2 v, float time, inout float2 id )
		{
			float2 n = floor( v );
			float2 f = frac( v );
			float F1 = 8.0;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float time34 = _CrackAngle;
			float2 coords34 = i.uv_texcoord * _CrackScale;
			float2 id34 = 0;
			float voroi34 = voronoi34( coords34, time34,id34 );
			float4 temp_output_40_0 = ( _CrackColor * step( voroi34 , _CrackProgress ) );
			...
			float4 clampResult43 = clamp( ( min( ( temp_output_16_0 * tex2DNode23 ) , ( tex2DNode23 * _LineStrength ) ) + temp_output_40_0 ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
			o.Alpha = clampResult43.r;
		}
...
/*ASEBEGIN
Version=17400
713;73;810;651;597.7011;-331.6138;1.360357;True;False
Node;AmplifyShaderEditor.RangedFloatNode;10;-1549.377,574.2566;Inherit;False;Property;_Timescale;Timescale;4;0;Create;True;0;0;False;0;1;0.8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;25;-1227.162,997.3224;Inherit;False;Property;_GradientLinesScaleDotCom;GradientLinesScaleDotCom;8;0;Create;True;0;0;False;0;1;0.27;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-1006.972,1366.531;Inherit;False;Property;_LinesSpeedScale;LinesSpeedScale;10;0;Create;True;0;0;False;0;1;0.06;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-1343.977,396.7694;Inherit;False;Property;_Float1;Float 1;5;0;Create;True;0;0;False;0;1;75.46;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;27;-910.1622,1159.323;Inherit;False;Property;_LineDirection;LineDirection;9;0;Create;True;0;0;False;0;0,-1;0.21,-1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleTimeNode;28;-776.59,1365.439;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;37;-354.123,1670.247;Inherit;False;Property;_CrackScale;CrackScale;13;0;Create;True;0;0;False;0;0;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;38;-371.123,1578.247;Inherit;False;Property;_CrackAngle;CrackAngle;12;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;3;-964.308,407.9875;Inherit;False;0;0;1;1;6;True;1;False;3;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0.18;False;2;FLOAT;0;FLOAT;1
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-529.48,524.3132;Inherit;False;Property;_OpacityTest;OpacityTest;3;0;Create;True;0;0;False;0;1;0.13;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;35;-531.123,1435.247;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;39;68.87695,1376.247;Inherit;False;Property;_CrackProgress;CrackProgress;14;0;Create;True;0;0;False;0;0;0.005;0;0.005;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;32;-278.4423,1099.17;Inherit;False;Property;_LineStrength;LineStrength;11;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.VoronoiNode;34;-204.5624,1445.691;Inherit;True;0;0;1;2;1;False;1;False;3;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;2;FLOAT;0;FLOAT;1
Node;AmplifyShaderEditor.SamplerNode;23;-445.1622,854.3224;Inherit;True;Property;_TextureSample1;Texture Sample 1;7;0;Create;True;0;0;False;0;-1;05aa43dbbeddb24419e5b5b6e734d595;61c0b9c0523734e0e91bc6043c72a490;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StepOpNode;36;141.877,1526.247;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0.7;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;41;276.877,1181.247;Inherit;False;Property;_CrackColor;CrackColor;15;1;[HDR];Create;True;0;0;False;0;0,0,0,0;1024,1024,1024,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;40;386.877,1407.247;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;42;45.5553,915.9913;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;11;-469.8046,-40.30344;Inherit;False;Property;_BarrierGlow;BarrierGlow;0;1;[HDR];Create;True;0;0;False;0;0,0.225235,1.828908,0;0,248.9725,1024,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;20;-456.9617,-209.1216;Inherit;False;Property;_BarrierBaseColor;Barrier Base Color;6;1;[HDR];Create;True;0;0;False;0;1,0,0,0;0,1.398011,5.278032,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ClampOpNode;43;211.7112,840.3874;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
...
WireConnection;18;9;43;0
ASEEND*/
//CHKSM=21489AD3FD9998F2DCA1ECA71DF9DEA7FD245FA8