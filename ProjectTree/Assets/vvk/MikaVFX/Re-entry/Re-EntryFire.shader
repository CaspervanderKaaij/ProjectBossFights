...
Shader "Re-EntryFire"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float smoothstepResult7 = smoothstep( tex2D( _Noise, panner12 ).r , 1.0 , ( 1.0 - ( uv0_Noise.y - ( _Skiddadle * i.vertexColor.a ) ) ));
			float4 lerpResult9 = lerp( _Flame , _HighLight , smoothstepResult7);
			o.Emission = lerpResult9.rgb;
			o.Alpha = ( smoothstepResult7 * _OpacityMultiplier * i.vertexColor.a );
		}
...
/*ASEBEGIN
Version=17400
818;73;527;646;808.917;75.69287;1.61211;False;False
Node;AmplifyShaderEditor.VertexColorNode;17;-486.4631,505.2891;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-532.6613,-9.067908;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-145.3897,216.6637;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=D412E928A949E4E3AE3CBF57090C782FEA3855DE