...
Shader "BlackHole"
{
	Properties
	{
		...
		_Fade("Fade", 2D) = "white" {}
		_CasperValue1("CasperValue", Float) = 1
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Alpha = ( tex2D( _TextureSample0, panner3 ) * _Opacity * tex2D( _Fade, i.uv_texcoord, float2( 0,0 ), float2( 0,0 ) ) * _CasperValue1 ).r;
		}
...
/*ASEBEGIN
Version=17400
0;73;1924;928;530.8018;-261.932;1;True;False
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;8;-757.0756,637.1971;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-333.699,416.8789;Inherit;False;Property;_Opacity;Opacity;4;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;9;-504.0756,666.1971;Inherit;True;Property;_Fade;Fade;5;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Derivative;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;10;-103.8018,589.932;Inherit;False;Property;_CasperValue1;CasperValue;6;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;6;-179.699,300.8789;Inherit;False;4;4;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;3;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=B8036D89882BF8DE387B9B094F29E2759E9A7B42