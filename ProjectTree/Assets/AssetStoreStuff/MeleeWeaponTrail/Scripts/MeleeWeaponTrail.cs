...
public class MeleeWeaponTrail : MonoBehaviour {
	...
	void Start () {
		...
		_trailObject.GetComponent<Renderer> ().shadowCastingMode = UnityEngine.Rendering.ShadowCastingMode.Off;
	...
	void OnDisable () {
		...
		_trailObject.GetComponent<Renderer> ().enabled = false;
	}

	void OnEnable () {
		if (_trailObject != null) {
			_trailObject.GetComponent<Renderer> ().enabled = true;
		}
	}
